...
def sync_detailed(
    *,
    ...
    Args:
        body (OperatingMode): Represents the reader operating mode. Example: {'type': 'INVENTORY',
            'antennas': [1, 2, 3], 'transmitPower': 30.1, 'antennaStopCondition': [{'type':
            'DURATION', 'value': 500}, {'type': 'INVENTORY_COUNT', 'value': 1}, {'type': 'GPI',
            'value': {'port': 2, 'signal': 'HIGH'}}], 'tagMetaData': ['PC', 'CRC', {'userDefined':
            'readerABC'}], 'rssiFilter': {'threshold': -72}}.
