...
from ...models.set_autostart_userapp_body import SetAutostartUserappBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/cloud/apps/{appname}/autostart".format(appname=appname,),
    }
