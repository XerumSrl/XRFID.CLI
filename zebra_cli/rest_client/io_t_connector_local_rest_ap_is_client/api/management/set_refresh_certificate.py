...
from ...models.set_refresh_certificate_body import SetRefreshCertificateBody
...
def _get_kwargs(
    certificate: str,
    *,
    body: SetRefreshCertificateBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/cloud/certificates/{certificate}".format(certificate=certificate,),
    }
