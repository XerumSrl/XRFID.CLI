...
@_attrs_define
class All:
    """ Adjust cable loss compensation for all available read points

        Attributes:
            cable_length (int): Cable Length Field. Accepts float values
            cable_loss_per_hundred_ft (int): Cable Loss per Hundred Feet. Accepts float values
     """
