...
from ..models.aws_additional_qos import AWSAdditionalQos
from ..models.aws_additional_qos import check_aws_additional_qos
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="AWSAdditional")
...
class AWSAdditional:
    """ 
        Attributes:
            ...
            qos (Union[Unset, AWSAdditionalQos]): QOS level
    ...
    qos: Union[Unset, AWSAdditionalQos] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        qos: Union[Unset, AWSAdditionalQos]
        if isinstance(_qos,  Unset):
            qos = UNSET
        else:
            qos = check_aws_additional_qos(_qos)
        ...
        aws_additional.additional_properties = d
        return aws_additional
