...
T = TypeVar("T", bound="ManagementEventsConfigurationWarningsFlash")



@_attrs_define
class ManagementEventsConfigurationWarningsFlash:
    """ Flash Usage Warning Alerts

        Attributes:
            threshold (float): Warning FLASH usage limit Default: 80.0. Example: 90.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        management_events_configuration_warnings_flash = cls(
            threshold=threshold,
            report_interval_in_sec=report_interval_in_sec,
        )


        management_events_configuration_warnings_flash.additional_properties = d
        return management_events_configuration_warnings_flash
