...
class RssiFilter:
    ...
    Note: Currently ONLY supported by the FX9600.
        ...
        Attributes:
            threshold (Union[Unset, int]): Threshold (in dbm) below which the radio will ignore a tag response
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rssi_filter.additional_properties = d
        return rssi_filter
