...
T = TypeVar("T", bound="ManagementEventsConfigurationWarningsRam")



@_attrs_define
class ManagementEventsConfigurationWarningsRam:
    """ RAM Usage Warning Alerts

        Attributes:
            threshold (float): Warning RAM usage limit Default: 90.0. Example: 90.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        management_events_configuration_warnings_ram = cls(
            threshold=threshold,
            report_interval_in_sec=report_interval_in_sec,
        )


        management_events_configuration_warnings_ram.additional_properties = d
        return management_events_configuration_warnings_ram
