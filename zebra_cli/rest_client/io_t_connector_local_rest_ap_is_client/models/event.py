...
if TYPE_CHECKING:
  from ..models.event_connections_item import EventConnectionsItem
...
class Event:
    """ Configuration of Event Channel
        ...
        Attributes:
            connections (Union[Unset, list['EventConnectionsItem']]):
     """

    connections: Union[Unset, list['EventConnectionsItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for connections_item_data in (_connections or []):
            connections_item = EventConnectionsItem.from_dict(connections_item_data)
